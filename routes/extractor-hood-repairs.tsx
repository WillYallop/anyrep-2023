...
export default function ExtractorHoodRepairs() {
  // SEO
  const SEO = {
    meta: {
      title: "Extractor Hood Repairs | Norwich, Norfolk | Book online",
      description:
        "Book your extractor hood repair online for same or next-day repairs. We have over 20 years of experience serving the Norwich, Norfolk area. Book online today!",
    },
    og: {
      title: "Extractor Hood Repairs | Norwich, Norfolk | Book online",
      description:
  ...
  return (
    <MainWrapper seo={SEO} head={Head}>
      <SimpleHeroBlock
        title={<Fragment>We can repair any extractor hood brand!</Fragment>}
        description={
          "If you have a faulty extractor hood, don't hesitate to call Anyrep today! Book online in under a minute!"
        }
        ...
        textarea={
          <Fragment>
            <P
              background={"light"}
              text={
                "When your Extractor Hood breaks down, the impact is drastic. So we ensure Anyrep will do all it can to get your Extractor Hood up and running like new. Most repairs are completed on the first visit and on the same day where possible."
              }
      ...
      <SimpleCardGridBlock
        ...
        cards={[
          ...
          {
            title: "Not extracting",
            body: "",
          },
          {
            title: "Broken fan motor",
            body: "",
          },
          {
            title: "Damaged exterior",
            body: "",
          },
          {
            title: "Old filter",
